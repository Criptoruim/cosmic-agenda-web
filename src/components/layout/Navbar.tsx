        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-4">
              ...
              <Link to="/heatmap" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-white dark:hover:border-purple-500 hover:border-gray-300">
                Heatmap
              </Link>
            </div>
          </div>
